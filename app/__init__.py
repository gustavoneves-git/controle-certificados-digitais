...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        MICROSOFT_GRAPH_USER_EMAIL=os.getenv("MICROSOFT_GRAPH_USER_EMAIL", os.getenv("ONVIO_EMAIL", "")),
        MICROSOFT_GRAPH_LOOKBACK_MINUTES=int(os.getenv("MICROSOFT_GRAPH_LOOKBACK_MINUTES", "10")),
        MICROSOFT_GRAPH_POLL_SECONDS=int(os.getenv("MICROSOFT_GRAPH_POLL_SECONDS", "45")),
